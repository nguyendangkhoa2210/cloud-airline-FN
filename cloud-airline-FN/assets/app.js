...
const MOCK_FLIGHTS = [
  ...
  // ===== Thêm khung giờ cho tuyến JFK <-> LHR ===============================
  {
    id: 6, flightNumber: 'CA103', origin: 'New York (JFK)', destination: 'London (LHR)',
    departureTime: '7:30 PM', arrivalTime: '6:30 AM (+1)', duration: '7h 00m',
    priceSkyBoss: 2800, priceEco: 1000, pricePromo: 600, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 7, flightNumber: 'CA107', origin: 'New York (JFK)', destination: 'London (LHR)',
    departureTime: '6:00 AM', arrivalTime: '5:00 PM', duration: '7h 00m',
    priceSkyBoss: 2400, priceEco: 900, pricePromo: 500, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 8, flightNumber: 'CA104', origin: 'London (LHR)', destination: 'New York (JFK)',
    departureTime: '8:00 PM', arrivalTime: '11:00 PM', duration: '7h 45m',
    priceSkyBoss: 2700, priceEco: 1000, pricePromo: 600, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 9, flightNumber: 'CA108', origin: 'London (LHR)', destination: 'New York (JFK)',
    departureTime: '6:45 AM', arrivalTime: '9:30 AM', duration: '7h 45m',
    priceSkyBoss: 2450, priceEco: 920, pricePromo: 520, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  // ===== Thêm khung giờ cho tuyến JFK <-> DAD =================================
  {
    id: 10, flightNumber: 'CA205', origin: 'New York (JFK)', destination: 'Da Nang (DAD)',
    departureTime: '11:45 PM', arrivalTime: '10:45 PM (+2)', duration: '18h 30m',
    priceSkyBoss: 5600, priceEco: 1950, pricePromo: 1300, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 11, flightNumber: 'CA207', origin: 'New York (JFK)', destination: 'Da Nang (DAD)',
    departureTime: '2:30 PM', arrivalTime: '1:30 PM (+1)', duration: '17h 45m',
    priceSkyBoss: 5250, priceEco: 1800, pricePromo: 1150, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 12, flightNumber: 'CA211', origin: 'Da Nang (DAD)', destination: 'New York (JFK)',
    departureTime: '11:00 PM', arrivalTime: '5:30 AM (+1)', duration: '18h 15m',
    priceSkyBoss: 5300, priceEco: 1800, pricePromo: 1150, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 13, flightNumber: 'CA213', origin: 'Da Nang (DAD)', destination: 'New York (JFK)',
    departureTime: '7:00 AM', arrivalTime: '1:30 PM', duration: '18h 15m',
    priceSkyBoss: 4950, priceEco: 1700, pricePromo: 1050, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  // ===== Tuyến MỚI: New York (JFK) <-> Paris (CDG) ============================
  {
    id: 14, flightNumber: 'CA301', origin: 'New York (JFK)', destination: 'Paris (CDG)',
    departureTime: '8:00 AM', arrivalTime: '9:15 PM', duration: '7h 15m',
    priceSkyBoss: 2650, priceEco: 1000, pricePromo: 600, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 15, flightNumber: 'CA303', origin: 'New York (JFK)', destination: 'Paris (CDG)',
    departureTime: '9:30 PM', arrivalTime: '10:45 AM (+1)', duration: '7h 15m',
    priceSkyBoss: 2450, priceEco: 930, pricePromo: 560, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 16, flightNumber: 'CA302', origin: 'Paris (CDG)', destination: 'New York (JFK)',
    departureTime: '11:00 AM', arrivalTime: '1:45 PM', duration: '7h 45m',
    priceSkyBoss: 2700, priceEco: 1020, pricePromo: 610, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 17, flightNumber: 'CA304', origin: 'Paris (CDG)', destination: 'New York (JFK)',
    departureTime: '6:15 PM', arrivalTime: '9:00 PM', duration: '7h 45m',
    priceSkyBoss: 2500, priceEco: 950, pricePromo: 570, status: 'Scheduled',
    aircraft: 'Boeing 787-9 Dreamliner', baggage: '25kg free checked + 7kg carry-on',
    emissions: '-20% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  // ===== Tuyến MỚI: New York (JFK) <-> Tokyo (HND) ============================
  {
    id: 18, flightNumber: 'CA401', origin: 'New York (JFK)', destination: 'Tokyo (HND)',
    departureTime: '12:30 PM', arrivalTime: '4:15 PM (+1)', duration: '14h 45m',
    priceSkyBoss: 5900, priceEco: 2100, pricePromo: 1400, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 19, flightNumber: 'CA403', origin: 'New York (JFK)', destination: 'Tokyo (HND)',
    departureTime: '11:00 PM', arrivalTime: '2:45 AM (+2)', duration: '14h 45m',
    priceSkyBoss: 5600, priceEco: 1980, pricePromo: 1300, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 20, flightNumber: 'CA402', origin: 'Tokyo (HND)', destination: 'New York (JFK)',
    departureTime: '5:30 PM', arrivalTime: '3:15 PM', duration: '12h 45m',
    priceSkyBoss: 5750, priceEco: 2050, pricePromo: 1350, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 21, flightNumber: 'CA404', origin: 'Tokyo (HND)', destination: 'New York (JFK)',
    departureTime: '10:15 AM', arrivalTime: '8:00 AM', duration: '12h 45m',
    priceSkyBoss: 5500, priceEco: 1930, pricePromo: 1250, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  // ===== Tuyến MỚI: Da Nang (DAD) <-> London (LHR) ============================
  {
    id: 22, flightNumber: 'CA501', origin: 'Da Nang (DAD)', destination: 'London (LHR)',
    departureTime: '1:00 AM', arrivalTime: '7:30 AM (+1)', duration: '16h 30m',
    priceSkyBoss: 5800, priceEco: 2050, pricePromo: 1350, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  },
  {
    id: 23, flightNumber: 'CA502', origin: 'London (LHR)', destination: 'Da Nang (DAD)',
    departureTime: '10:00 PM', arrivalTime: '6:30 PM (+1)', duration: '16h 30m',
    priceSkyBoss: 5850, priceEco: 2080, pricePromo: 1370, status: 'Scheduled',
    aircraft: 'Airbus A350-900 XWB', baggage: '30kg free checked + 7kg carry-on',
    emissions: '-15% CO2 reduction certified', seatsLeftSkyBoss: 8, seatsLeftEco: 24, seatsLeftPromo: 24
  }
];
...
// ============================================================================
// KẾT NỐI BACKEND (PHP + MySQL) — xem chi tiết trong php_mysql_export/
// Mọi hàm gọi API đều có try/catch: nếu chưa cài driver MySQL / chưa
// chạy XAMPP, web vẫn dùng được bình thường nhờ dữ liệu mẫu (chế độ offline).
// ============================================================================
const API_BASE = 'php_mysql_export/api';

// ============================================================================
// CHỐNG XSS LƯU TRỮ (Stored XSS) — họ tên hành khách do người dùng TỰ NHẬP lúc
// đặt vé (không qua kiểm duyệt nội dung), nên KHÔNG ĐƯỢC tin tưởng khi hiển thị
// lại qua innerHTML ở bất kỳ đâu (Sảnh chung, bảng Admin, vé in PDF...). Hàm
// này dùng chung cho TOÀN BỘ app — bất kỳ chỗ nào chèn dữ liệu từ DB vào
// innerHTML đều phải bọc qua escapeHtml() trước.
// ============================================================================
...
// ============================================================================
// CSRF TOKEN — cấp bởi session.php ngay khi tải trang, đính kèm ở MỌI request
// làm thay đổi dữ liệu (đặt vé, hủy vé, đổi trạng thái chuyến, giữ ghế...).
// Không cần refetch lại sau khi login/logout vì token gắn theo session, còn
// session_regenerate_id() không xoá dữ liệu $_SESSION cũ (chỉ đổi session ID).
// ============================================================================
let csrfToken = '';
...
async function fetchCsrfToken() {
  try {
    ...
    console.warn('Không lấy được CSRF token, các thao tác đặt/hủy vé có thể bị chặn:', e);
  }
}

// Helper: trả về headers chuẩn (Content-Type + X-CSRF-Token) cho mọi fetch() có gửi body JSON
function jsonHeaders() {
  return { 'Content-Type': 'application/json', 'X-CSRF-Token': csrfToken };
}

// ============================================================================
// apiPost — helper POST dùng chung, TỰ ĐỘNG XỬ LÝ khi CSRF token hết hạn.
// Trước đây mỗi khi session server hết hạn giữa chừng (VD: để tab mở lâu lúc
// điền form đặt vé), người dùng sẽ thấy lỗi "Phiên làm việc hết hạn, vui lòng
// tải lại trang!" và phải F5 thủ công, MẤT HẾT dữ liệu đang điền dở. Giờ nếu
// gặp đúng lỗi đó, hàm này tự lấy token mới (fetchCsrfToken) rồi GỬI LẠI request
// đúng 1 lần — người dùng hầu như không nhận ra có sự cố, không mất dữ liệu.
// ============================================================================
async function apiPost(url, bodyObj) {
  let res = await fetch(url, { method: 'POST', headers: jsonHeaders(), body: JSON.stringify(bodyObj) });
  let data = await res.json();

  const isCsrfExpired = data && data.success === false && res.status === 403
    && typeof data.message === 'string' && data.message.includes('hết hạn');

  if (isCsrfExpired) {
    await fetchCsrfToken(); // lấy token mới từ session.php
    res = await fetch(url, { method: 'POST', headers: jsonHeaders(), body: JSON.stringify(bodyObj) });
    data = await res.json();
  }
...
// Vẽ badge nhỏ trên nav báo đang ở chế độ Online (đã nối MySQL) hay Offline (dữ liệu mẫu)
...
let flightsDb = [...MOCK_FLIGHTS]; // sẽ được thay bằng dữ liệu thật từ MySQL nếu kết nối được

// Danh sách tài khoản tạm trong bộ nhớ — CHỈ dùng khi không kết nối được MySQL
...
// Tải danh sách chuyến bay thật từ MySQL. Gọi 1 lần khi mở app; nếu đang
...
async function loadFlightsFromServer() {
  try {
    ...
    if (data.success && Array.isArray(data.flights) && data.flights.length > 0) {
      ...
      console.log(`✅ Đã tải ${flightsDb.length} chuyến bay từ MySQL.`);
    } else {
      throw new Error('API trả về dữ liệu rỗng hoặc không hợp lệ');
    }
  } catch (err) {
    console.warn('⚠️ Không kết nối được MySQL — dùng dữ liệu mẫu (MOCK_FLIGHTS). Lý do:', err.message);
...
async function loadMyBookingsFromServer() {
  try {
    ...
    bookingsDb = [];
    console.warn('⚠️ Không tải được vé từ MySQL. Lý do:', err.message);
    triggerToast('⚠️ Không tải được danh sách vé từ MySQL — kiểm tra lại kết nối backend.');
  }
...
async function loadAdminBookingsFromServer() {
  try {
    ...
    bookingsDb = [];
    console.warn('⚠️ Không tải được danh sách vé admin từ MySQL. Lý do:', err.message);
    triggerToast('⚠️ Không tải được danh sách vé từ MySQL — kiểm tra lại kết nối backend.');
  }
          ...
          <div class="bg-white border-2 ${isCancelled ? 'border-dashed border-slate-200 opacity-60' : 'border-slate-100 hover:border-emerald-500/30'} p-5 rounded-3xl transition-all duration-300 relative flex flex-col justify-between hover:shadow-md">
            <div>
              <div class="flex justify-between items-center mb-3">
                <span class="text-[10px] text-slate-500 font-black font-mono tracking-wider">VÉ: ${escapeHtml(b.id)}</span>
                ${statusBadge}
              </div>
              <div class="space-y-1.5 text-xs text-slate-700 text-left">
                <div class="flex justify-between">
                  <span class="text-slate-500">✈️ Chuyến:</span>
                  <strong class="text-slate-900 font-mono font-bold">${escapeHtml(b.flightNumber)} (${escapeHtml(getCabinLabelShort(b.cabinClass || 'Eco'))})</strong>
                </div>
                <div class="flex justify-between">
                  <span class="text-slate-500">👤 Hành khách:</span>
                  <strong class="text-slate-900 font-bold">${escapeHtml(b.passengerName)}</strong>
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-slate-500">💺 Số ghế:</span>
                  <strong class="text-slate-900 font-mono font-extrabold text-xs px-2 py-0.5 bg-sky-50 rounded text-sky-700">${escapeHtml(b.seat || 'K3')}</strong>
                </div>
                <div class="flex justify-between">
                  <span class="text-slate-500">📅 Khởi hành:</span>
                  <strong class="text-slate-900 font-mono font-bold">${escapeHtml(b.date || '2026-09-15')}</strong>
                </div>
            ...
            ${!isCancelled ? `
              <div class="mt-4 pt-3 border-t border-slate-100 flex justify-end gap-2 flex-wrap">
                <button onclick="printLobbyTicket('${escapeHtml(b.id).replace(/'/g, "\\'")}')" class="px-4 py-2 bg-sky-50 hover:bg-sky-100 text-sky-700 border border-sky-100 rounded-xl transition-all text-xs font-bold font-sans flex items-center gap-1.5 cursor-pointer">
                  <i data-lucide="download" class="w-3.5 h-3.5"></i>
                  <span>Tải PDF</span>
                </button>
                <button onclick="changeBookingPrompt('${escapeHtml(b.id).replace(/'/g, "\\'")}')" class="px-4 py-2 bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-100 rounded-xl transition-all text-xs font-bold font-sans flex items-center gap-1.5 cursor-pointer">
                  <i data-lucide="calendar-clock" class="w-3.5 h-3.5"></i>
                  <span>Đổi vé</span>
                </button>
                <button onclick="cancelBookingTicket('${escapeHtml(b.id).replace(/'/g, "\\'")}')" class="px-4 py-2 bg-red-50 hover:bg-red-100 text-red-650 hover:text-red-700 border border-red-100 rounded-xl transition-all text-xs font-bold font-sans flex items-center gap-1.5 cursor-pointer">
...
window.cancelBookingTicket = function(bookingId) {
  ...
  if (b) {
    showConfirmDialog(
      ...
      `Bạn có thực sự chắc chắn muốn hủy đặt vé máy bay <strong>${escapeHtml(b.flightNumber)}</strong> trị giá <strong class="text-red-650">$${escapeHtml(b.totalPrice)}</strong> cho hành khách <strong>${escapeHtml(b.passengerName)}</strong>?<br><br><span class="text-xs text-slate-500">Sau khi xác nhận, ghế số <strong>${escapeHtml(b.seat)}</strong> sẽ lập tức được giải phóng trên hệ thống radar.</span>`,
      async function() {
        triggerToast('⏳ Đang xử lý hủy vé...');

        // Gọi MySQL hủy vé TRƯỚC — chỉ cập nhật giao diện SAU KHI server xác nhận
        ...
        try {
          const data = await apiPost(`${API_BASE}/cancel_booking.php`, { bookingId });

          if (!data.success) {
            triggerToast(`❌ Không thể hủy vé: ${data.message || 'MySQL từ chối yêu cầu.'}`);
            return;
          }
          isBackendOnline = true;
        } catch (err) {
          triggerToast('❌ Không kết nối được MySQL — vé KHÔNG được hủy. Vui lòng kiểm tra lại XAMPP/driver rồi thử lại!');
          console.warn('⚠️ Không đồng bộ được việc hủy vé với MySQL. Lý do:', err.message);
          return;
        }

        // Tới đây nghĩa là MySQL đã xác nhận hủy thành công — giờ mới cập nhật giao diện
        b.status = 'Cancelled';
...
function initializeApp() {
  ...
  renderMegaNavBar();
  fetchCsrfToken(); // Lấy CSRF token ngay từ đầu, cần cho mọi thao tác đặt/hủy vé sau này
...
// hủy giao dịch đang đặt dở rồi điều hướng tới screen-error (tương đương "error.html")
// để thông báo rõ ràng lý do. KHÔNG đăng xuất tài khoản — đúng theo đặc tả use case
// "Đặt vé" (nhánh <<extend>> chỉ ghi "hủy giao dịch, về màn hình lỗi", không đề cập
// đăng xuất). Bảo mật tổng thể của tài khoản vẫn do session PHP phía server đảm nhiệm
// (đã cấu hình sống 2 giờ ở config.php) — đây chỉ là giữ chỗ tạm thời của 1 giao dịch.
function handleBookingSessionExpired() {
  // Nhả ngay các ghế đang giữ trên server (best-effort) thay vì đợi tự hết hạn
  // sau tối đa 5 phút nữa — để ghế trống lại cho khách khác ngay lập tức.
  if (currentBooking.selectedFlight) {
    currentBooking.selectedSeats.forEach(seatId => releaseSeatHold(seatId));
  }
...
function setupActionListeners() {
  ...
  if (authForm) {
    authForm.addEventListener('submit', async (e) => {
      ...
      if (window.currentAuthTab === 'signup') {
        ...
        try {
          const data = await apiPost(`${API_BASE}/register.php`, { email, password, fullName: nameField });
          isBackendOnline = true;
          if (!data.success) {
          ...
          // Không kết nối được MySQL -> lưu tạm trong bộ nhớ (chế độ demo offline)
          ...
          triggerToast('⚠️ (Offline) Chưa kết nối được MySQL — tài khoản chỉ lưu tạm trong phiên này.');
        }
      ...
      try {
        const data = await apiPost(`${API_BASE}/login.php`, { email, password });
        isBackendOnline = true;
        ...
        if (data.user.role === 'admin') {
          ...
          apiPost(`${API_BASE}/logout.php`, {}).catch(() => {});
          return;
        }
        ...
        // Không kết nối được MySQL -> thử khớp với danh sách tài khoản tạm trong bộ nhớ
        ...
        if (userRecord && userRecord.password === password) {
          ...
          triggerToast(`👋 (Offline) Chào mừng Hội viên: ${userFullName}! Lưu ý: chưa kết nối MySQL nên KHÔNG có dữ liệu vé thật.`);
          navigateTo('lobby');
          // Không startCountdown() ở đây — lý do tương tự nhánh login thật phía trên.
        } else {
          triggerToast('⚠️ Không kết nối được MySQL và không khớp tài khoản tạm.');
        }
      }
    });
  }
  ...
  if (btnCompleteCheckout) {
    btnCompleteCheckout.addEventListener('click', async () => {
      ...
      try {
        const data = await apiPost(`${API_BASE}/book.php`, {
        ...
        if (!data.success) {
          triggerToast(`❌ Không thể đặt vé: ${data.message || 'MySQL từ chối yêu cầu.'}`);
        ...
        triggerToast('❌ Không kết nối được MySQL — vé KHÔNG được lưu. Vui lòng kiểm tra lại XAMPP/driver rồi thử lại!');
        console.warn('⚠️ Không lưu được vé vào MySQL. Lý do:', err.message);
        btnCompleteCheckout.disabled = false;
        return;
      }
  ...
  // Form XEM chi tiết vé cho KHÁCH LẺ bằng Mã đặt chỗ + Họ tên (chỉ để XEM,
  // không hủy được từ đây — hủy vé vẫn phải qua Passport ở form bên dưới để
  // đảm bảo an toàn hơn, vì họ tên dễ đoán/biết hơn số passport).
  const guestLookupForm = document.getElementById('guest-lookup-form');
  if (guestLookupForm) {
    guestLookupForm.addEventListener('submit', async (e) => {
      e.preventDefault();
      const bookingCode = document.getElementById('guest-lookup-booking-code').value.trim();
      const fullName = document.getElementById('guest-lookup-fullname').value.trim();
      const btnSubmit = document.getElementById('btn-guest-lookup-submit');
      const resultBox = document.getElementById('guest-lookup-result');

      if (!bookingCode || !fullName) {
        triggerToast('⚠️ Vui lòng nhập đầy đủ Mã đặt chỗ và Họ tên hành khách!');
        return;
      }
      ...
      try {
        const data = await apiPost(`${API_BASE}/lookup_booking.php`, { bookingCode, fullName });

        if (!data.success) {
          triggerToast(`❌ ${data.message || 'Không tìm thấy vé khớp với thông tin đã nhập!'}`);
          btnSubmit.disabled = false;
          return;
        }

        const b = data.booking;
        // Escape dữ liệu từ DB trước khi chèn vào innerHTML — họ tên hành khách do
        // người dùng tự nhập lúc đặt vé, không nên tin tưởng 100% khi hiển thị lại.
        const esc = escapeHtml; // dùng chung hàm escape toàn app, không định nghĩa lại
        const route = b.return ? `${esc(b.outbound.origin)} ⇄ ${esc(b.outbound.destination)} (khứ hồi)` : `${esc(b.outbound.origin)} ➔ ${esc(b.outbound.destination)}`;
        const flightLabel = b.return ? `${b.outbound.flightNumber} (đi) / ${b.return.flightNumber} (về)` : b.outbound.flightNumber;
        ...
        resultBox.innerHTML = `
          <div class="flex justify-between"><span class="text-slate-500">Trạng thái:</span>${statusBadge}</div>
          <div class="flex justify-between"><span class="text-slate-500">Chuyến bay:</span><strong>${esc(flightLabel)}</strong></div>
          <div class="flex justify-between"><span class="text-slate-500">Lộ trình:</span><strong>${route}</strong></div>
          <div class="flex justify-between"><span class="text-slate-500">Hành khách:</span><strong>${b.passengers.map(p => esc(p.fullName)).join(', ')}</strong></div>
          <div class="flex justify-between"><span class="text-slate-500">Ghế:</span><strong>${b.passengers.map(p => esc(p.seatNumber)).join(', ')}</strong></div>
          <div class="flex justify-between"><span class="text-slate-500">Hạng vé:</span><strong>${getCabinLabel(b.cabinClass)}</strong></div>
          <div class="flex justify-between"><span class="text-slate-500">Tổng tiền:</span><strong class="text-emerald-600">$${Number(b.totalPrice).toLocaleString()}</strong></div>
          <div class="pt-3 mt-2 border-t border-slate-200 flex justify-end">
            <button onclick="printGuestLookupTicket(window.__lastGuestLookup)" class="px-4 py-2 bg-sky-100 hover:bg-sky-200 text-sky-700 rounded-xl text-xs font-bold flex items-center gap-1.5 cursor-pointer">
              <i data-lucide="download" class="w-3.5 h-3.5"></i><span>Tải vé PDF</span>
            </button>
          </div>
        `;
        window.__lastGuestLookup = b; // Lưu tạm để nút "Tải vé PDF" phía trên dùng lại, tránh nhúng JSON thô vào HTML (an toàn hơn)
        resultBox.classList.remove('hidden');
        if (typeof lucide !== 'undefined') lucide.createIcons();

        // Điền sẵn Mã vé xuống form Hủy ở Bước 2 cho tiện, khách chỉ cần gõ passport
        const cancelCodeInput = document.getElementById('guest-cancel-booking-code');
        if (cancelCodeInput) cancelCodeInput.value = bookingCode;

        btnSubmit.disabled = false;
      } catch (err) {
        triggerToast('❌ Lỗi kết nối server, vui lòng thử lại!');
        btnSubmit.disabled = false;
      }
    });
  }
  ...
  if (guestCancelForm) {
    guestCancelForm.addEventListener('submit', async (e) => {
      ...
      try {
        const data = await apiPost(`${API_BASE}/cancel_booking_guest.php`, { bookingId: bookingCode, passportId });
        ...
        triggerToast('❌ Không kết nối được MySQL — vé KHÔNG được hủy. Vui lòng kiểm tra lại XAMPP/driver rồi thử lại!');
        console.warn('⚠️ Không đồng bộ được việc hủy vé khách lẻ với MySQL. Lý do:', err.message);
        btnSubmit.disabled = false;
      }
    });
  }
...
async function loginAsAdminViaShortcut() {
  ...
  try {
    const data = await apiPost(`${API_BASE}/login.php`, { email: ADMIN_SHORTCUT_EMAIL, password: ADMIN_SHORTCUT_PASSWORD });
    ...
    console.warn('⚠️ Không đăng nhập admin được qua MySQL, dùng chế độ Admin offline. Lý do:', err.message);
  }

  // Fallback OFFLINE — giữ hành vi demo cũ khi chưa kết nối được MySQL. KHÔNG có
  ...
  triggerToast('🔑 KÍCH HOẠT ADMIN — chế độ OFFLINE (chưa kết nối MySQL, không có dữ liệu thật)!');
  navigateTo('admin');
...
// bookedSeats được tải bất đồng bộ từ MySQL rồi mới vẽ lại lưới ghế
async function renderSeatsScreen() {
  ...
  // ── Lấy danh sách ghế đã đặt thật từ MySQL ─────────────────────────
  ...
  if (currentBooking.selectedFlight) {
    try {
      ...
      if (data.success && Array.isArray(data.bookedSeats)) {
        ...
        isBackendOnline = true;
        console.log(`✅ Sơ đồ ghế: ${bookedSeats.length} ghế đã đặt từ MySQL.`);
      }
    } catch (err) {
      console.warn('⚠️ Không lấy được danh sách ghế thật từ MySQL — dùng dữ liệu mẫu.');
    }
  }
  updateBackendStatusBadge();
...
function toggleSeatSelection(seatId) {
  ...
  if (index !== -1) { // Bỏ chọn
    ...
    // Nhả ghế đã giữ tạm — không cần chờ phản hồi, không chặn UI (best-effort)
    releaseSeatHold(seatId);
  } else { // Chọn ghế
    ...
    // ── Giữ ghế tạm thời trên server (5 phút) TRƯỚC khi hiển thị đã chọn ──
    // Tránh trường hợp 2 khách bấm trùng ghế gần như cùng lúc trong lúc điền
    // form/chờ thanh toán. Nếu server báo ghế đã bị người khác giữ -> huỷ chọn.
    holdSeatOnServer(seatId, btn);
    return; // holdSeatOnServer sẽ tự hoàn tất phần UI khi có phản hồi từ server
  }
...
// Giữ ghế tạm thời trên server (5 phút) rồi mới cập nhật UI đã chọn — tránh 2
// khách chọn trùng ghế cùng lúc trước khi ai đó thật sự bấm "Thanh toán".
async function holdSeatOnServer(seatId, btn) {
  btn.disabled = true;
  try {
    const data = await apiPost(`${API_BASE}/hold_seat.php`, { flightId: currentBooking.selectedFlight.id, seatNumber: seatId });

    if (!data.success) {
      triggerToast(`🔒 ${data.message || 'Ghế này vừa được người khác giữ, vui lòng chọn ghế khác!'}`);
      btn.disabled = false;
      return;
    }
    ...
    if (summarySeatsList) {
      const progress = `${currentBooking.selectedSeats.length}/${currentBooking.passengerCount}`;
      summarySeatsList.textContent = `${currentBooking.selectedSeats.join(', ')} (${progress})`;
    }
    const priceIndicator = document.getElementById('seats-summary-total-price');
    if (priceIndicator) {
      priceIndicator.textContent = `$${calculateTotalBill().toLocaleString()}`;
    ...
    triggerToast('⚠️ Lỗi kết nối khi giữ ghế, vui lòng thử lại!');
  } finally {
    btn.disabled = false;
  }
}

// Nhả ghế đang giữ tạm (best-effort, không cần chờ / không cần xử lý lỗi vì
// ghế sẽ tự động hết hạn sau 5 phút dù request này có thất bại hay không)
function releaseSeatHold(seatId) {
  if (!currentBooking.selectedFlight) return;
  apiPost(`${API_BASE}/release_seat.php`, { flightId: currentBooking.selectedFlight.id, seatNumber: seatId }).catch(() => {});
}
...
// ============================================================================
// IN VÉ ĐIỆN TỬ RA PDF (dùng chung: màn hình thành công, lịch sử vé, tra cứu)
// Cách làm: đổ HTML vé vào #print-ticket-area rồi gọi window.print(). CSS
// @media print trong style.css sẽ ẩn hết phần còn lại của trang, người dùng
// chọn "Lưu dưới dạng PDF" trong hộp thoại in để có file PDF thật sự.
// ============================================================================
function buildTicketHtml(t) {
  // t = { bookingCode, passengerLine, flightLabel, routeLabel, dateLabel, cabinLabel, seatLabel, totalLabel, status }
  // Escape TẤT CẢ field ngay tại điểm build HTML này — đây là hàm DÙNG CHUNG cho
  // cả 3 nút "Tải vé PDF" (thành công / lobby / tra cứu khách lẻ), nên escape ở
  // đây 1 lần là đủ bảo vệ chống XSS cho toàn bộ luồng in vé.
  const bookingCode = escapeHtml(t.bookingCode);
  const passengerLine = escapeHtml(t.passengerLine);
  const flightLabel = escapeHtml(t.flightLabel);
  const routeLabel = escapeHtml(t.routeLabel);
  const dateLabel = escapeHtml(t.dateLabel);
  const cabinLabel = escapeHtml(t.cabinLabel);
  const seatLabel = escapeHtml(t.seatLabel);
  const totalLabel = escapeHtml(t.totalLabel);
  const status = escapeHtml(t.status || 'CONFIRMED');

  return `
    <div class="print-ticket-card">
      <div style="display:flex;justify-content:space-between;align-items:center;border-bottom:2px dashed #cbd5e1;padding-bottom:12px;margin-bottom:12px;">
        <strong style="font-size:18px;">☁️ CLOUD AIRLINE — VÉ ĐIỆN TỬ (E-TICKET)</strong>
        <span style="font-size:11px;padding:4px 10px;border-radius:8px;background:#ecfdf5;color:#059669;font-weight:bold;">${status}</span>
      </div>
      <div class="print-ticket-row"><span>Mã đặt chỗ (PNR):</span><strong>${bookingCode}</strong></div>
      <div class="print-ticket-row"><span>Hành khách:</span><strong>${passengerLine}</strong></div>
      <div class="print-ticket-row"><span>Chuyến bay:</span><strong>${flightLabel}</strong></div>
      <div class="print-ticket-row"><span>Lộ trình:</span><strong>${routeLabel}</strong></div>
      <div class="print-ticket-row"><span>Ngày bay:</span><strong>${dateLabel}</strong></div>
      <div class="print-ticket-row"><span>Hạng vé:</span><strong>${cabinLabel}</strong></div>
      <div class="print-ticket-row"><span>Số ghế:</span><strong>${seatLabel}</strong></div>
      <div class="print-ticket-row" style="border-bottom:none;padding-top:12px;font-size:14px;"><span>Tổng thanh toán:</span><strong>${totalLabel}</strong></div>
      <p style="font-size:10px;color:#64748b;margin-top:16px;">Vé điện tử này được xuất tự động bởi hệ thống Cloud Airline — vui lòng mang theo giấy tờ tùy thân trùng khớp thông tin hành khách khi làm thủ tục.</p>
    </div>
  `;
}

function triggerTicketPrint(ticketFields) {
  const area = document.getElementById('print-ticket-area');
  if (!area) return;
  area.innerHTML = buildTicketHtml(ticketFields);
  // Đợi 1 nhịp render rồi mới in, tránh trường hợp trình duyệt in trang trắng
  setTimeout(() => window.print(), 80);
}

// Dùng ngay tại màn hình "Đặt vé thành công" — đọc lại đúng nội dung đã render
window.printSuccessTicket = function () {
  triggerTicketPrint({
    bookingCode: document.getElementById('success-booking-id')?.textContent || '',
    passengerLine: document.getElementById('success-passenger')?.textContent || '',
    flightLabel: document.getElementById('success-flight-number')?.textContent || '',
    routeLabel: document.getElementById('success-route')?.textContent || '',
    dateLabel: document.getElementById('success-departure-time')?.textContent || '',
    cabinLabel: document.getElementById('success-class')?.textContent || '',
    seatLabel: document.getElementById('success-seat')?.textContent || '',
    totalLabel: document.getElementById('success-total-paid')?.textContent || '',
    status: 'CONFIRMED',
  });
};

// Dùng cho 1 vé bất kỳ trong "Danh sách vé đã đặt" ở Sảnh chung (bookingsDb)
window.printLobbyTicket = function (bookingId) {
  const b = bookingsDb.find(item => item.id === bookingId);
  if (!b) return;
  triggerTicketPrint({
    bookingCode: b.id,
    passengerLine: (b.passengerNames && b.passengerNames.length) ? b.passengerNames.join(', ') : b.passengerName,
    flightLabel: b.flightNumber,
    routeLabel: getRouteLabel ? getRouteLabel() : '',
    dateLabel: b.returnDate ? `Đi: ${b.date} • Về: ${b.returnDate}` : b.date,
    cabinLabel: getCabinLabel ? getCabinLabel(b.cabinClass) : b.cabinClass,
    seatLabel: b.seat,
    totalLabel: `$${Number(b.totalPrice).toLocaleString()}`,
    status: b.status === 'Cancelled' ? 'ĐÃ HỦY' : 'CONFIRMED',
  });
};

// Dùng cho kết quả tra cứu vé khách lẻ (dữ liệu trả về từ lookup_booking.php)
window.printGuestLookupTicket = function (booking) {
  const route = booking.return
    ? `${booking.outbound.origin} ⇄ ${booking.outbound.destination} (khứ hồi)`
    : `${booking.outbound.origin} ➔ ${booking.outbound.destination}`;
  const flightLabel = booking.return
    ? `${booking.outbound.flightNumber} (đi) / ${booking.return.flightNumber} (về)`
    : booking.outbound.flightNumber;
  const seatLabel = booking.passengers.map(p => p.seatNumber).join(', ');

  triggerTicketPrint({
    bookingCode: booking.id,
    passengerLine: booking.passengers.map(p => p.fullName).join(', '),
    flightLabel,
    routeLabel: route,
    dateLabel: booking.returnDate ? `Đi: ${booking.departureDate} • Về: ${booking.returnDate}` : booking.departureDate,
    cabinLabel: getCabinLabel ? getCabinLabel(booking.cabinClass) : booking.cabinClass,
    seatLabel,
    totalLabel: `$${Number(booking.totalPrice).toLocaleString()}`,
    status: booking.status === 'Cancelled' ? 'ĐÃ HỦY' : 'CONFIRMED',
  });
};

// Nhật ký thao tác Admin (Audit Log) — tải danh sách 50 thao tác gần nhất
async function loadAuditLog() {
  const tbody = document.getElementById('admin-audit-log-table-body');
  if (!tbody) return;
  tbody.innerHTML = `<tr><td colspan="5" class="py-4 text-center text-xs text-slate-400 font-mono">Đang tải...</td></tr>`;
  try {
    const res = await fetch(`${API_BASE}/admin_audit_log.php`);
    const data = await res.json();
    if (!data.success || !data.logs.length) {
      tbody.innerHTML = `<tr><td colspan="5" class="py-4 text-center text-xs text-slate-500 font-sans">Chưa có thao tác quản trị nào được ghi nhận.</td></tr>`;
      return;
    }
    tbody.innerHTML = data.logs.map(l => `
      <tr class="border-b border-white/5 hover:bg-white/[0.02] text-xs font-mono transition-colors">
        <td class="px-5 py-3 text-[#bacbbc]">${l.createdAt}</td>
        <td class="px-5 py-3 text-white font-bold">${l.adminName}</td>
        <td class="px-5 py-3 text-[#2af598]">${l.action}</td>
        <td class="px-5 py-3 text-amber-300">${l.target || '-'}</td>
        <td class="px-5 py-3 text-[#bacbbc] font-sans">${l.details || ''}</td>
      </tr>
    `).join('');
  } catch (e) {
    tbody.innerHTML = `<tr><td colspan="5" class="py-4 text-center text-xs text-red-400 font-mono">Lỗi tải nhật ký thao tác!</td></tr>`;
  }
}
  ...
  if (bookingsTableBody) {
    ...
    if (bookingsDb.length === 0) {
      ...
      bookingsDb.forEach(b => {
        ...
        row.innerHTML = `
          <td class="px-5 py-4 font-mono font-black text-slate-700">${escapeHtml(b.id)}</td>
          <td class="px-5 py-4 font-bold text-slate-900">${escapeHtml(b.passengerName)}</td>
          <td class="px-5 py-4 font-mono font-bold text-sky-700">${escapeHtml(b.flightNumber)}</td>
          <td class="px-5 py-4">
            <span class="px-2 py-0.5 bg-slate-100 text-slate-700 rounded text-[10px] font-mono font-extrabold">${escapeHtml(getCabinLabel(b.cabinClass))}</span> • 
            <strong class="text-slate-950 font-mono font-black">${escapeHtml(b.seat || 'K3')}</strong>
          </td>
          <td class="px-5 py-4 font-mono font-bold text-emerald-600 text-sm">$${escapeHtml(b.totalPrice)}</td>
          <td class="px-5 py-4">${statusBadge}</td>
          <td class="px-5 py-4 text-right">
            <button onclick="cancelBookingTicket('${escapeHtml(b.id).replace(/'/g, "\\'")}')" 
...
// ============================================================================
// MODAL ĐỔI VÉ — chọn chuyến bay mới bằng card trực quan thay vì prompt() thô.
// Chính sách phí đổi vé hiển thị ở đây CHỈ để tham khảo cho khách xem trước;
// quy tắc THẬT SỰ áp dụng và kiểm tra lại 1 lần nữa ở server (change_booking.php)
// — không bao giờ tin để giá/phí client tính rồi gửi lên.
// ============================================================================
let changeModalState = { bookingId: null, selectedFlightId: null };

window.changeBookingPrompt = function (bookingId) {
  const b = bookingsDb.find(item => item.id === bookingId);
  if (!b) return;

  if (b.cabinClass === 'Promo') {
    triggerToast('⚠️ Vé hạng Promo (Tiết Kiệm) không được phép đổi vé theo chính sách!');
    return;
  }
  if (!b.outboundFlightId || !b.origin || !b.destination) {
    triggerToast('⚠️ Thiếu dữ liệu chuyến bay để đổi vé, vui lòng tải lại trang!');
    return;
  }

  changeModalState = { bookingId, selectedFlightId: null };

  document.getElementById('change-modal-booking-code').textContent = bookingId;
  document.getElementById('change-modal-route').textContent = `${b.origin} ➔ ${b.destination} · Hạng ${getCabinLabel ? getCabinLabel(b.cabinClass) : b.cabinClass}`;
  document.getElementById('change-modal-date').value = b.date;
  document.getElementById('change-modal-fee-note').innerHTML = b.cabinClass === 'Eco'
    ? '💰 Hạng Eco: phụ phí đổi vé <strong>$50</strong> (thu ngay khi xác nhận).'
    : '🎉 Hạng SkyBoss: đổi vé <strong>miễn phí</strong>.';
  document.getElementById('change-modal-confirm-btn').disabled = true;

  // Danh sách chuyến cùng tuyến, lấy từ flightsDb đã tải sẵn (không cần gọi API riêng)
  const sameRouteFlights = flightsDb.filter(f =>
    f.origin === b.origin && f.destination === b.destination && f.status !== 'Cancelled'
  );

  const listEl = document.getElementById('change-modal-flight-list');
  if (sameRouteFlights.length === 0) {
    listEl.innerHTML = `<p class="col-span-2 text-xs text-slate-400 text-center py-6">Hiện không có chuyến bay nào khác trên tuyến này.</p>`;
  } else {
    listEl.innerHTML = sameRouteFlights.map(f => {
      const price = b.cabinClass === 'SkyBoss' ? f.priceSkyBoss : (b.cabinClass === 'Promo' ? f.pricePromo : f.priceEco);
      const seatsLeft = b.cabinClass === 'SkyBoss' ? f.seatsLeftSkyBoss : (b.cabinClass === 'Promo' ? f.seatsLeftPromo : f.seatsLeftEco);
      const isCurrent = f.id === b.outboundFlightId;
      const isFull = !isCurrent && seatsLeft <= 0;
      const disabled = isCurrent || isFull;
      return `
        <button type="button" onclick="selectChangeModalFlight(${f.id})" id="change-flight-card-${f.id}"
          class="text-left border rounded-2xl p-4 transition-all ${disabled ? 'border-slate-200 bg-slate-50 opacity-60 cursor-not-allowed' : 'border-slate-200 hover:border-amber-400 hover:shadow-md cursor-pointer'}"
          ${disabled ? 'disabled' : ''}>
          <div class="flex justify-between items-center mb-1.5">
            <span class="text-xs font-mono font-bold text-slate-900">${escapeHtml(f.flightNumber)}</span>
            ${isCurrent
              ? '<span class="text-[9px] font-mono text-slate-400 uppercase">Chuyến hiện tại</span>'
              : isFull
                ? '<span class="text-[9px] font-mono text-red-500 uppercase font-bold">Hết chỗ</span>'
                : `<span class="text-xs font-mono font-black text-emerald-600">$${price.toLocaleString()}</span>`}
          </div>
          <div class="flex justify-between text-[11px] font-mono text-slate-500">
            <span>${escapeHtml(f.departureTime)}</span>
            <span>→</span>
            <span>${escapeHtml(f.arrivalTime)}</span>
          </div>
          ${!isCurrent && !isFull ? `<div class="text-[9px] font-mono text-slate-400 mt-1.5">Còn ${seatsLeft} vé hạng ${escapeHtml(getCabinLabelShort(b.cabinClass))}</div>` : ''}
        </button>
      `;
    }).join('');
  }
...
window.selectChangeModalFlight = function (flightId) {
  changeModalState.selectedFlightId = flightId;
  document.querySelectorAll('[id^="change-flight-card-"]').forEach(el => {
    el.classList.remove('border-amber-500', 'bg-amber-50', 'shadow-md');
  });
  const card = document.getElementById(`change-flight-card-${flightId}`);
  if (card) card.classList.add('border-amber-500', 'bg-amber-50', 'shadow-md');
  document.getElementById('change-modal-confirm-btn').disabled = false;
};

window.closeChangeBookingModal = function () {
  const modal = document.getElementById('change-booking-modal');
  modal.classList.add('hidden');
  modal.classList.remove('flex');
  changeModalState = { bookingId: null, selectedFlightId: null };
};

window.confirmChangeBooking = async function () {
  const { bookingId, selectedFlightId } = changeModalState;
  const newDate = document.getElementById('change-modal-date').value;
  if (!bookingId || !selectedFlightId || !newDate) {
    triggerToast('⚠️ Vui lòng chọn chuyến bay và ngày bay mới!');
    return;
  }

  const btn = document.getElementById('change-modal-confirm-btn');
  btn.disabled = true;

  try {
    const data = await apiPost(`${API_BASE}/change_booking.php`, { bookingId, newOutboundFlightId: selectedFlightId, newDepartureDate: newDate });
    if (!data.success) {
    ...
    loadMyBookingsFromServer();
  } catch (e) {
    triggerToast('❌ Lỗi kết nối khi đổi vé!');
    btn.disabled = false;
  }
};

// Đổi trạng thái chuyến bay (Admin)
async function adminSetFlightStatus(flightId, newStatus) {
  ...
  // Đồng bộ vào MySQL (chỉ admin mới gọi được — server tự kiểm tra qua session)
  try {
    const data = await apiPost(`${API_BASE}/admin_flight_status.php`, { flightId, status: newStatus });
    if (data.success) isBackendOnline = true;
    else console.warn('⚠️ MySQL từ chối cập nhật trạng thái chuyến bay:', data.message);
  } catch (err) {
    console.warn('⚠️ Không đồng bộ được trạng thái chuyến bay với MySQL. Lý do:', err.message);
  }
}
...
// ============================================================================
// CLOUDBOT — trợ lý ảo dạng chat. Gọi chatbot.php ở server: nếu có cấu hình
// ANTHROPIC_API_KEY thì trả lời bằng AI thật (Claude), nếu không thì dùng bộ
// trả lời thông minh dựa trên dữ liệu thật (chuyến bay, vé của khách...) —
// xem chi tiết trong php_mysql_export/api/chatbot.php.
// ============================================================================

let chatMessages = [
  { sender: 'bot', text: 'Xin chào! Mình là CloudBot 🤖 — trợ lý ảo của Cloud Airline. Mình có thể giúp gì cho hành trình của bạn? Thử hỏi mình "vé của tôi" hoặc "có chuyến bay đi Tokyo không" xem nhé!', time: nowTimeLabel() }
];
let chatUnreadCount = 0;
let chatIsWaitingReply = false;
...
function renderChatMessages() {
  ...
  list.innerHTML = chatMessages.map(m => `
    <div class="chat-msg-bubble flex items-end gap-2 ${m.sender === 'user' ? 'justify-end' : 'justify-start'}">
      ${m.sender === 'bot' ? `
        <div class="w-6 h-6 rounded-full bg-gradient-to-tr from-sky-400 to-emerald-400 flex items-center justify-center shrink-0 mb-3.5">
          <i data-lucide="bot" class="w-3.5 h-3.5 text-slate-900"></i>
        </div>
      ` : ''}
      <div class="max-w-[78%]">
        <div class="px-3.5 py-2.5 rounded-2xl text-xs leading-relaxed whitespace-pre-line ${
          m.sender === 'user'
        ...
        <span class="block text-[9px] text-slate-400 font-mono mt-1 ${m.sender === 'user' ? 'text-right' : 'text-left'}">${m.time || ''}</span>
      </div>
    </div>
  `).join('');

  // Bong bóng "đang gõ..." trong lúc chờ CloudBot trả lời
  if (chatIsWaitingReply) {
    list.innerHTML += `
      <div class="chat-msg-bubble flex items-end gap-2 justify-start">
        <div class="w-6 h-6 rounded-full bg-gradient-to-tr from-sky-400 to-emerald-400 flex items-center justify-center shrink-0">
          <i data-lucide="bot" class="w-3.5 h-3.5 text-slate-900"></i>
        </div>
        <div class="px-4 py-3 rounded-2xl rounded-bl-sm bg-white border border-slate-100 shadow-sm flex items-center gap-1">
...
async function sendChatMessage() {
  ...
  if (!input || chatIsWaitingReply) return;
  const text = input.value.trim();
  if (!text) return;

  chatMessages.push({ sender: 'user', text, time: nowTimeLabel() });
  input.value = '';
  input.disabled = true;
  if (sendBtn) sendBtn.disabled = true;
  chatIsWaitingReply = true;
  renderChatMessages();

  // Gửi kèm 6 tin nhắn gần nhất làm ngữ cảnh hội thoại (đủ để AI hiểu mạch
  // chuyện mà không tốn quá nhiều token nếu đang dùng chế độ AI thật)
  const history = chatMessages.slice(-7, -1).map(m => ({ sender: m.sender, text: m.text }));

  try {
    const data = await apiPost(`${API_BASE}/chatbot.php`, { message: text, history });
    const replyText = data.success
      ? data.reply
      : 'Xin lỗi, mình đang gặp chút trục trặc kỹ thuật 😅 Bạn thử hỏi lại sau ít phút nhé!';
    chatMessages.push({ sender: 'bot', text: replyText, time: nowTimeLabel() });
  } catch (e) {
    chatMessages.push({ sender: 'bot', text: 'Không kết nối được tới CloudBot lúc này, vui lòng thử lại sau ít phút nhé! 🙏', time: nowTimeLabel() });
  } finally {
    chatIsWaitingReply = false;
    input.disabled = false;
    if (sendBtn) sendBtn.disabled = false;
    renderChatMessages();
    input.focus();

    // Nếu khung chat đang ĐÓNG lúc trả lời về (VD: người dùng bấm hỏi nhanh rồi
    // click ra chỗ khác) thì hiện badge tin nhắn mới trên nút nổi
    const panel = document.getElementById('chat-widget-panel');
