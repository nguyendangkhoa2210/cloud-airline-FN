...
-- QUAN TRỌNG: ép kết nối hiện tại đọc/ghi bằng utf8mb4 ngay từ đây. Nếu thiếu
-- dòng này, tiếng Việt có dấu ("Quản Trị Viên"...) có thể bị LƯU SAI (mã hóa
-- lỗi kiểu "Quáº£n Trá»‹") tùy theo charset mặc định của công cụ import (một số
-- bản mysql CLI/Adminer mặc định dùng latin1 khi kết nối) — dù bảng đã khai
-- báo utf8mb4, charset của KẾT NỐI lúc import mới là thứ quyết định dữ liệu
-- ghi vào có đúng hay không.
SET NAMES utf8mb4;
