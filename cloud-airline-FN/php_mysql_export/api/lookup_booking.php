<?php
/**
 * POST /php_mysql_export/api/lookup_booking.php
 * Body JSON: { "bookingCode": "CH-849204", "fullName": "Nguyen Dang Khoa" }
 *
 * Tra cứu chi tiết 1 vé bằng Mã đặt chỗ (PNR) + Họ tên hành khách — giống tính
 * năng "Quản lý đặt chỗ" của Vietnam Airlines / Vietjet, dùng cho khách vãng lai
 * chưa đăng nhập tài khoản.
 *
 * BẢO MẬT: so khớp fullName KHÔNG phân biệt hoa/thường & khoảng trắng thừa, nhưng
 * vẫn PHẢI khớp chính xác họ tên — chỉ biết đúng mã vé thôi là chưa đủ (mã vé dạng
 * CH-xxxxxx có thể bị đoán/liệt kê tuần tự), giúp hạn chế 1 người dò được vé của
 * người khác chỉ bằng cách thử số ngẫu nhiên.
 * Không phân biệt lỗi "không tìm thấy vé" và "sai họ tên" trong message trả về.
 */
