-- ============================================================================
-- MIGRATION: Bổ sung THÊM chuyến bay (nhiều khung giờ hơn + 2 điểm đến mới:
-- Paris CDG, Tokyo HND) — CHỈ INSERT, không đụng tới 5 chuyến bay gốc trong
-- database_mysql.sql, nên an toàn chạy sau khi đã có dữ liệu/booking thật.
-- Chạy SAU database_mysql.sql + migration_seat_holds.sql + migration_security.sql.
-- ============================================================================
